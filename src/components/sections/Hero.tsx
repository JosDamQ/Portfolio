      ...
      <div className="relative z-10 container mx-auto px-6 text-center text-white">
        ...
        >
          <motion.div
            ...
            whileHover={{ y: -2 }}
          >
            <span className="text-sm text-secondary-400 mb-3 group-hover:text-white transition-colors">
            ...
            >
              <ChevronDown className="w-5 h-5 text-secondary-400 group-hover:text-white transition-colors" />
            </motion.div>
          </motion.div>
        </motion.div>
      </div>
